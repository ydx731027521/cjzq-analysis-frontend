    ...
    <div class="recheck-record-table">
      <el-table
        ...
        <el-table-column
                ...
                align="center">
          <template slot-scope="{row}">
              <!-- <span class="blue" v-if="row.qcStatus==='未开始'">修改</span> -->
              ...
              <!-- <router-link  class="blue text" v-else :to="{path:'/quality/recheckdetail',query:{originalQcBatchId:row.originalQcBatchId,qcBatchId:row.qcBatchId}}" tag="span">质检结果</router-link> -->
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页 -->
...
let {CONFIG_SELECT,CONVENTION_BATCH_AND_STATUS,SPOT_CHECK_CONVENTION_LIST, RECHECK_RECORD_RECHECKSTATUS,RECHECK_RECORD_DELETE} = URL
export default {
  name:'recheckRecord',
  components:{
    EssantialSearch,
  ...
  methods:{
    ...
    handleChangeCurrentPageSize(val){
      ...
      this.currentPage = 1
      // util.getData(this,CONFIG_LIST,"essentialTableData")
      util.wrapToTop(this)
    },
